...
<details>
<summary>NeoPixel Colored LEDs</summary>
...
<details>
<summary>Four Digit Display</summary>

* Download the [four_digit_display.py](https://github.com/forbeskcg/pinball-immersive/blob/main/Python%20Libraries/four_digit_display.py) library (read library for more documentation and examples)
...
<details>
<summary>Playing Tones and Notes on the Piezo Buzzer</summary>

* Download the [music.py](https://github.com/forbeskcg/pinball-immersive/blob/main/Python%20Libraries/music.py) library (read library for more detailed documentation)
* Import the libraries:
import board, music
